    ...
    return (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto">
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500  mb-10 border-b border-gray-200">
                        <li>
                        ...
                        <li>
                            <a href="#Hobbies" className="text-gray-800 hover:text-gray-900">Hobbies</a>
                        </li>
                        <li>
                            <a href="#Projects" className="text-gray-800 hover:text-gray-900">Projects</a>
                        </li>
                        <li>
                    ...
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="https://www.instagram.com/benj3rt/" className="block  text-gray-900 transition-all duration-500 hover:text-green-600 ">
                            <svg className="w-[1.688rem] h-[1.688rem] " viewBox="0 0 29 29" fill="none" xmlns="http://www.w</svg>3.org/2000/svg">
                        ...
                        <a href="https://www.facebook.com/jenbert.duazo" className="block  text-gray-900 transition-all duration-500 hover:text-green-600 ">
                    ...
                    <span className="text-lg text-gray-500 text-center block">©<a href="/">Jenbert Duazo Portfolio</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
